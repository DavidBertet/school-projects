...
ll	r2 , 361 + end - from1 # Load offsets for
ll	r3 , 361 + end - from2 + 4 # the two str
ll	r5 , 361 + end - from3 + 8 # the two str
ll	r7 , 361 + end - from4 + 12 # the two str
ll	r9 , 361 + end - from5 + 16 # the two str
ll      r4 , 361
